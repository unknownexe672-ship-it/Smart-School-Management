...
const menuItems = [
  ...
  { icon: Calendar, label: "Class Scheduler", path: "/schedules" },
  ...
  { icon: Droplets, label: "Water Monitor", path: "/water-monitor" },
  { icon: Zap, label: "Electric Monitor", path: "/electric-monitor" },
  { icon: MessageCircle, label: "Amira AI", path: "/amira" },
];
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              One Dashboard. Every School Decision.
            </p>
          </div>
          <Button
            onClick={() => startLogin()}
              ...
              <div className="flex items-center gap-3">
                <div className="flex flex-col gap-1">
                  <span className="tracking-tight text-foreground font-medium">
                    {activeMenuItem?.label ?? "Smart School Management"}
                  </span>
                </div>
              </div>
            </div>
